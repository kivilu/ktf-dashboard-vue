<template>
    <el-dialog v-el-drag-dialog :title="textMap[dialogStatus]" :visible.sync="visible" @dragDialog="handleDrag">
        <el-form ref="dataForm" :rules="rules" :model="dataForm" label-position="left" label-width="100px"
            style="margin-left:50px; margin-right:100px;" :width="DLG_WIDTH">
...
<script>
    ...
    import { getInfo, save, update } from '@/api/user'
    export default {
        name: 'SysUserDlg',

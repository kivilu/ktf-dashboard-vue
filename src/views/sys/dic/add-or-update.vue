  ...
  >
    ...
    >
      <el-form-item label="变量名称" prop="varName">
        <el-input v-model="dataForm.varName" placeholder="变量名称" />
      </el-form-item>
      <el-form-item label="变量代码" prop="varCode">
        <el-input v-model="dataForm.varCode" placeholder="变量代码" />
      </el-form-item>

      <el-form-item label="变量值" prop="varValue">
        <el-input v-model="dataForm.varValue" placeholder="变量值" />
      </el-form-item>

      <el-form-item label="上级变量" prop="parent">
        <tree-input
          ref="dicListTree"
...
import { getInfo, save, update, getChildren } from '@/api/sys/dic'
export default {
  name: 'SysDicDlg',

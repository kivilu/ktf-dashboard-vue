<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column :label="LB.common.GMT_CREATE" align="center">
        <template slot-scope="{row}">
          <span>{{ row.gmtCreate | parseTime() }}</span>
        </template>
      </el-table-column>
      <el-table-column :label="LB.common.GMT_UPDATE" align="center">
        <template slot-scope="{row}">
...
<script>
import { page, remove } from '@/api/permission/role'

    ...
    >
      <el-form-item label="类型" prop="resourceType">
        <el-radio-group v-model="dataForm.resourceType">
          <el-radio v-for="item in menuTypes" :key="item.key" :label="item.key">
            {{ item.name }}
          </el-radio>
        </el-radio-group>
      </el-form-item>
